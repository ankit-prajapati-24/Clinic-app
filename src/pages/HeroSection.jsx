    ...
    <div className=" bg-gradient-to-br from-blue-200 to-white mx-auto px-4 py-16 flex flex-row md:flex-row items-center">
      ...
      <div className="w-full md:w-1/2 pr-8 mb-8 md:mb-0" data-aos="fade-right">
        ...
        <div className="space-x-4 space-y-2">
          ...
          <button className="bg-white text-sky-700 px-7 py-4 sm:px-6 sm:py-3 rounded-lg border border-sky-700 hover:bg-sky-50 transition duration-300 hover:bg-sky-500 hover:text-white cursor-pointer" onClick={() => navigate("/LabAndMedicalPage")}>
           Now  Explore
          </button>
        </div>
      </div>
