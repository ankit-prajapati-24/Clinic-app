...
const UserTransactions = () => {
  ...
  return (
    <div className=" bg-gradient-to-br from-sky-200 to-white  flex items-center justify-center mt-6">
   
      {transactions.length === 0 ? (
        
        <div className="text-2xl font-semibold text-gray-600 min-h-screen" >
